...
public class ActualSpending {
    static String[][] table;
    static double foodActual;
    static double shopActual;
    static double transActual;
    ...
    public static void actualSpending(){
        ...
        leftOverTrans = ((shopValue * income)/100) - shopActual;
        leftOverShop = ((transValue *income)/100) -transActual;
